...
class LED(QLabel):
    def __init__(self,x,parent=None):
        ...
        self.led_b = QImage()
        self.led_b.load(self.ico_path + './data/ico/ledlightblue.ico')
        self.led_g = QImage()
        self.led_g.load(self.ico_path + './data/ico/ledgreen.ico')
        self.led_r = QImage()
        self.led_r.load(self.ico_path + './data/ico/ledred.ico')
        self.led_y = QImage()
        self.led_y.load(self.ico_path + './data/ico/ledgray.ico')
